...
path_sources=[path_source_folders+str(folder+1)+'/'+str(folder+1)+'.fits' for folder in range(len_folders)]
source_names=[str(folder+1)+'/'+str(folder+1)+'.fits' for folder in range(len_folders)]
